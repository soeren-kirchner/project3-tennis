...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, fc1_units=300, fc2_units=400):
    ...
    def add_parameter_noise(self, scalar=0.1):
        for layer in [0, 3, 5]:
            self.seq[layer].weight.data += (
                torch.randn_like(self.seq[layer].weight.data) * scalar
            )
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, fcs1_units=300, fc2_units=400):
        ...
        self.seq1 = nn.Sequential(
            ...
            nn.BatchNorm1d(fcs1_units), nn.ReLU()
        )
